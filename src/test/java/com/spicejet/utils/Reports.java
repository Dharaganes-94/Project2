...
public class Reports  {
	...
	public void startReport()
	{
		try
		{
			sparkReports= new ExtentSparkReporter(System.getProperty("user.dir")+"/SpiceJetAutomationReport.html");
			sparkReports.config().setReportName("SpiceJet Web Automation Report");
			sparkReports.config().setDocumentTitle("Website Automation Report");
